  ...
  return (
    <div>
        ...
        <main className='grid grid-cols-1 lg:grid-cols-9'>
            <section className='order-2 mx-auto max-w-xl pb-12 lg:mx-0 lg:max-w-none lg:col-span-5
                lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44'>
            <Link href="/">
                <div className='relative hidden ml-4 h-24 w-12 cursor-pointer transition 
                    lg:inline-flex'>
                    <Image 
                        src={'/appleIconBlack.png'}
                        alt={'appleIcon'}
            ...
            <div className='my-4 mx-4 space-y-2 rounded-md border border-gray-300
                p-4 lg:ml-14'>
                <p>Order updates</p>
                <p className='text-sm text-gray-600'>
            ...
            {mounted && (
                <section className='overflow-y-auto border-y border-l border-gray-300 bg-[#FAFAFA]
                    lg:order-2 lg:col-span-4 lg:h-screen lg:border-y-0'>
                    <div className={`w-full ${showOrderSummaryCondition && ' border-b '} 
                    ...
                    {showOrderSummaryCondition && (
                        <div className='mx-auto max-w-xl divide-y border-gray-300 px-4 py-4 lg:mx-0 lg:max-w-lg
                            lg:px-10 lg:py-16'>
                                ...
                                {products.map((product) => (
                                    <div key={product.id} className='flex items-center space-x-4 text-sm font-medium'>
                                        <div className='relative flex h-16 w-16 items-center justify-center rounded-md 
                                            border border-gray-300 bg-[#f1f1f1] text-xs text-white'>
                                            <div className='relative h-7 w-7 animate-bounce rounded-md'>
                                                <Image src={'/appleIconBlack.png'}
                                                    alt='appleIcon'
                                                    objectFit='contain'
                                                    layout='fill'
                                                />
